...
def show_in_between_instruction():
    ...
    if not st.session_state.demo_mode_active and not st.session_state.study_mode_active:
        st.markdown(
            """
            <style>
            ...
            <div class="parent-container">
                <div class="arrow-text-container">
                    ...
                    <div class="instruction-text">Select a Mode</div>
                </div>
            </div>
            """,
            unsafe_allow_html=True
    ...
    elif st.session_state.study_xui_selection is None and st.session_state.study_mode_active and (not st.session_state.explanatory_xui_study_finished or not st.session_state.exploratory_xui_study_finished):
    ...
    elif st.session_state.study_mode_active:
